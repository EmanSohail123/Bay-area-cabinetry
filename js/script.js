...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadMapScript() {
        ...
        script.src = `https://maps.googleapis.com/maps/api/js?key=AIzaSyAuU2mgO9uRlLOsfdw6fjS05ta7XRyj_zg&callback=initMap`;
        script.defer = true;
        script.async = true;
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (form && mainContent) {
    ...
    // Place form at the end by default (so desktop order = content left, form right)
