document.addEventListener('DOMContentLoaded', function() {
    ...
    if (estimateForm && responseContainer) {
        estimateForm.addEventListener("submit", async (e) => {
            ...
            // Backend submission
            try {
                const response = await fetch("https://bay-area-cabinetry-backend.vercel.app/api/send-estimate", {
    method: "POST",
    headers: { 
    ...
    if (contactForm) {
        contactForm.addEventListener("submit", async (e) => {
            ...
            try {
              const response = await fetch("https://bay-area-cabinetry-backend.vercel.app/api/send-contact", {
    method: "POST",
    headers: { 
        "Content-Type": "application/json",
    },
